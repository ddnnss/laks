...
$.extend($.fn, {
    ...
    if (a.length > 0 || n.length > 0) {
        $document.themeLoadPlugin(["https://cdn.jsdelivr.net/blazy/latest/blazy.min.js"], ["http://vigoing.com/resource/plugins/plugin-css/plugin-blazy.min.css"], function() {
    ...
    if (e.length > 0) {
        $document.themeLoadPlugin(["https://cdnjs.cloudflare.com/ajax/libs/fixto/0.5.0/fixto.js"], ["http://vigoing.com/resource/plugins/plugin-css/plugin-sticky-classes.min.css"], function() {
            var t = function(t, e) {
    ...
    if (e.length > 0) {
        $document.themeLoadPlugin(["https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.min.js"], ["http://vigoing.com/resource/plugins/plugin-css/plugin-owl-carousel.min.css", "https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/assets/owl.carousel.min.css", "https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css"], function(t) {
            e.each(function() {
                var t = $(this),
